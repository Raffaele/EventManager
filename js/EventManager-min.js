...
(function(){function e(){function r(e){var t={on:function(n,r,i){if(!e.eventList[n]){e.eventList[n]=[]}e.eventList[n].push({callback:r,context:i||e});return e},off:function(n,r){var i=e.eventList[n],s,o;if(i){if(!r){e.eventList[n]=[]}else{s=i.length;for(o=0;o<s;o++){if(i[o].callback==r){i.splice(o,1);break}}}}return e},trigger:function(n){var r=e.eventList[n],i,s,o,u;if(r){u=[].slice.call(arguments,1);i=r.length;for(s=0;s<i;s++){o=r[s];o.callback.apply(o.context,u)}}return e},eventList:{}};i(e,t)}function i(e,t){for(var n in t){t.hasOwnProperty(n)&&(e[n]=t[n])}}var e,t,n;if(this.constructor==arguments.callee){r(this)}else{t=arguments[0]||{};r(t);return t}}if(typeof angular!="undefined"&&angular.module){ngEventManager=angular.module("EventManager",[]);ngEventManager.service("EventManager",function(){return e})}else{window.EventManager=e}})()